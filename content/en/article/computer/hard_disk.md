...
{{< figure src="/images/article/disk.png" >}}

                            图1-1   一块被拆开密封盖的硬盘
如图1-1 所示，这是一块被拆开的硬盘，中间是用于记录数据的铝合金盘片，固定在中心的轴上，由一个高速旋转的马达驱动。附着在盘片表面的扁平锥状物，就是用于在盘片上读写数据的磁头。
...
{{<figure src="/images/article/disk_in.png">}}
